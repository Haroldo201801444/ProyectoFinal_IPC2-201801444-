...
def generar_pdf_consultas():

    admin.generar_archivo_pdf()  #con este metodo generamos el archivo pdf 

    return Response(status=200,response="<h1>Se genero correctamente el documento pdf</h1>")
